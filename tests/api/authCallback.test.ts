...
type StubSession = { provider_token: string | null }
...
function makeSupabase({
  ...
  user = { id: 'auth-id', email: 'user@example.com', user_metadata: { full_name: 'Jane Doe' } } as StubUser,
  session = { provider_token: null } as StubSession,
