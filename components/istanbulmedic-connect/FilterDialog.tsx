            ...
            <DialogContent className="sm:max-w-[720px] w-full p-0 gap-0 overflow-hidden flex flex-col max-h-[70vh] sm:rounded-2xl border-0 shadow-2xl">
                    ...
                    <div className="space-y-8">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-sm font-medium border transition-all ${isSelected
                                                ? "bg-[#3EBBB7] text-white border-[#3EBBB7] hover:opacity-90"
                                                : "bg-white text-foreground border-border hover:border-[#3EBBB7] hover:text-[#3EBBB7]"
                                                }`}
                                        >
                                            {type}
                                        </button>
                        ...
                        <section>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-sm font-medium text-[#3EBBB7]">{localFilters.aiMatchScore}%+</span>
                            </div>
                                ...
                                {(Object.keys(localFilters.accreditations) as Accreditation[]).map((acc) => (
                                    <div key={acc} className="flex items-center space-x-3">
                                        <Checkbox
                                            ...
                                            className="h-5 w-5 border-2 border-input data-[state=checked]:border-[#3EBBB7] data-[state=checked]:bg-[#3EBBB7]"
                                        />
                                        <label
                                            htmlFor={`d-${acc}`}
                ...
                <DialogFooter className="border-t p-4 sm:px-6 flex flex-row items-center justify-between sm:justify-between bg-white w-full">
                    ...
                    <Button
                        onClick={handleApply}
                        size="lg"
                        className="bg-[#3EBBB7] hover:bg-[#2fa8a0] text-white font-semibold rounded-lg px-8"
                    >
                        Show results
                    </Button>
                </DialogFooter>
